...
#Adapt original report by adding functionality for subtotaling by product type and detailed classification(class, type, and subtype) of all products,
...
write.csv(grouped_sales_class, "sales_byclass.csv")
write.csv(grouped_sales_subtype, "sales_bysubtype.csv")
write.csv(grouped_sales_type, "sales_bytype.csv")
